...
docker run -d --name $dockerName -p 5672:5672 -p 15672:15672 -v /data/db/rabbitmq:/var/lib/rabbitmq --hostname space_rabbit -e RABBITMQ_DEFAULT_VHOST=space_vhost  -e RABBITMQ_DEFAULT_USER=admin -e RABBITMQ_DEFAULT_PASS=kgdiyniqmq $dockerInfo
